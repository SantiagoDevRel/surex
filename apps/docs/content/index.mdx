...
The word is **reviewed** — never an adjective that promises more than a static read of some source
can deliver. `clean` means precisely: this submitted
...
Read [Verdict ⊥ Tier](/concepts/verdict-and-tier) before you read a verdict.
